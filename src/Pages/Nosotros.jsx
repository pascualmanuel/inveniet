...
const Nosotros = () => {
  return (
    <>
      ...
      <div className="center max-w-[1077px]" style={{ marginBottom: "80px" }}>
        ...
        <p className="subH ">
          Inveniet nació de la necesidad de modernizar y optimizar la gestión de
          procesos orales judiciales en un mundo cada vez más digitalizado.
          ...
          procedimientos legales. Desde nuestros inicios, desarrollamos Inveniet
          en colaboración directa con profesionales del sector judicial para
          crear una plataforma que no solo sea poderosa, sino también intuitiva
          y fácil de usar.
        </p>
      </div>
    </>
